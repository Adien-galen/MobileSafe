package com.example.mobliesafe.db.dao;
...
public class AddressDao {
	...
	private static final String PATH = "data/data/com.example.mobliesafe/files/address.db";// 注意,该路径必须是data/data目录的文件,否则数据库访问不到
